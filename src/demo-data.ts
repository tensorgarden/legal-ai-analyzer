...
export const filingReadinessReviews: FilingReadinessReview[] = [
  {
    ...
    filingCandorStatus: "not-triggered",
    filingErrorDiscoveredAt: null,
    filingErrorSource: null,
    courtAndOpposingCounselAlertedAt: null,
    filingErrorSourceDisclosed: false,
    filingCorrectionNote: "No filing error is currently known. If counsel later discovers a citation, quotation, or factual assertion error, the team must promptly alert the court and opposing counsel, disclose whether AI contributed, and record the correction before further reliance.",
  },
  {
    id: "frr-002",
    contractId: "ctr-003",
    ...
    courtAndOpposingCounselAlertedAt: null,
    filingErrorSourceDisclosed: false,
    filingCorrectionNote: "No filing has been released, so a post-filing correction event is not active. The unresolved local-rule and authority checks must clear before this work is used externally.",
  },
  {
    id: "frr-003",
    contractId: "ctr-008",
    intendedUse: "court-filing",
    targetCourt: "U.S. Court of Appeals for the Ninth Circuit",
    courtAIDisclosureStatus: "required-complete",
    courtAIDisclosureSource: "Ninth Circuit Rule 32-1 filing guidance and the June 3, 2026 Lnu v. Blanche order support an AI-use certification with personal review of cited authorities and transparent correction of discovered errors.",
    courtAIDisclosureCheckedAt: "2026-06-10T17:00:00Z",
    status: "ready",
    citationsVerified: true,
    sourceTextVerified: true,
    independentLegalJudgmentConfirmed: true,
    ...
    reviewNote: "Counsel completed the correction record and independently rechecked the replacement authorities before approving further external use.",
    filingCandorStatus: "correction-disclosed",
    filingErrorDiscoveredAt: "2026-06-09T13:10:00Z",
    filingErrorSource: "ai-generated",
    courtAndOpposingCounselAlertedAt: "2026-06-09T14:00:00Z",
    filingErrorSourceDisclosed: true,
    filingCorrectionNote: "Counsel alerted the court and opposing counsel, disclosed that generative AI introduced the inaccurate authority, replaced the citation, and recorded the source-text recheck before any further filing.",
  },
  {
    id: "frr-004",
    contractId: "ctr-008",
    ...
    courtAIDisclosureStatus: "required-complete",
    courtAIDisclosureSource: "Ninth Circuit Rule 32-1 filing guidance and the June 3, 2026 Lnu v. Blanche order support an AI-use certification with personal review of cited authorities and transparent correction of discovered errors.",
    courtAIDisclosureCheckedAt: "2026-06-10T17:05:00Z",
    ...
    reviewedBy: null,
    reviewedAt: null,
    reviewNote: "Held for counsel because an authority error was discovered after filing; the source and correction path must be documented before any further external reliance.",
    filingCandorStatus: "correction-required",
    filingErrorDiscoveredAt: "2026-06-10T11:20:00Z",
    filingErrorSource: "ai-generated",
    courtAndOpposingCounselAlertedAt: null,
    filingErrorSourceDisclosed: false,
    filingCorrectionNote: "An authority error was found after the filing was prepared. Counsel must alert the court and opposing counsel immediately, disclose that generative AI contributed, and record a verified correction before any further external reliance.",
  },
];

export const canReleaseFiling = (review: FilingReadinessReview) =>
  review.status === "ready" &&
  review.filingCandorStatus !== "correction-required" &&
  (review.filingCandorStatus !== "correction-disclosed" || review.filingErrorSourceDisclosed);
